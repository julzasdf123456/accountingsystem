...
public class CheckVoucherController extends MenuControllerHandler implements Initializable {
    ...
    @FXML
    private Label totalDebit, totalCredit, total;
    ...
    private void getTotal(){
        ...
        total.setText("Total: "+ Utility.formatDecimal(tot));
        cvTable.refresh();
    }
