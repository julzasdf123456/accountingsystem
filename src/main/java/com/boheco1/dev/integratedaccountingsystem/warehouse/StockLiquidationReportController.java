...
public class StockLiquidationReportController extends MenuControllerHandler implements Initializable, SubMenuHelper {
    ...
    public void generateReport() {
        ...
        if (from == null) {
            ...
            Platform.runLater(() -> {
                try {
                    ObservableList<Stock> stocks = FXCollections.observableList(StockDAO.getReleasedStocks(from, to));
        ...
        if (from == null){
            ...
            if (selectedFile != null) {
                ...
                task.setOnSucceeded(wse -> {
                    ...
                    AlertDialogBuilder.messgeDialog("Stock Liquidation Report", "Stock Liquidation Report was successfully generated and saved on file!",
    ...
    public void createTable(){
        ...
        TableColumn<Stock, String> column3 = new TableColumn<>("Type");
        ...
        TableColumn<Stock, String> column31 = new TableColumn<>("Individual");
        ...
        TableColumn<Stock, String> column5 = new TableColumn<>("Quantity");
        column5.setMinWidth(75);
        column5.setCellValueFactory(stocks -> new SimpleStringProperty(stocks.getValue().getReleasing().getQuantity()+""));
        column5.setStyle("-fx-alignment: center;");

        TableColumn<Stock, String> column6 = new TableColumn<>("Threshold");
        ...
        this.stocksTable.getColumns().add(column31);
            ...
            Platform.runLater(() -> {
                try {
                    if (!page_cb.getSelectionModel().isEmpty() && from != null && to != null ) {
                        ...
                        ObservableList<Stock> stocks = FXCollections.observableList(StockDAO.getReleasedStocks(from, to, LIMIT, offset));
                        this.stocksTable.getItems().setAll(stocks);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
