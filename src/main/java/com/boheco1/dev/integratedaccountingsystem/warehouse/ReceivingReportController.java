...
public class ReceivingReportController extends MenuControllerHandler implements Initializable, SubMenuHelper {
    ...
    /**
     * Searches for Receiving Reports based on RRNO or date range
     * @return void
     */
    public void search(){
    ...
    /**
     * Generates the receiving reports when searching
     * @return void
     */
    @FXML
    ...
    /**
     * Creates the receiving reports table
     * @return void
     */
    ...
    /**
     * Generates and saves the receiving report based on the RR number
    ...
    /**
     * Generates and saves the receiving report based on the RR number
     * @param fileOut the pdf file pointer
     * @param rrno the receiving report number
     * @return void
     */
    public static void printReport(OutputStream fileOut, String rrno) throws Exception {
