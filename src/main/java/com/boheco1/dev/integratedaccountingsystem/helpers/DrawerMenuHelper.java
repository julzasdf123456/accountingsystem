...
public class DrawerMenuHelper {
    ...
    public static void setMenuButtonWithViewAndSubMenu(JFXButton button, FontIcon icon, List<JFXButton> drawerMenuList, String tooltipText, AnchorPane contentPane, String fxml, FlowPane subToolbar, MenuControllerHandler controller) {
        setMenuButtonWithViewAndSubMenu(button, icon, drawerMenuList, tooltipText, contentPane,fxml,subToolbar,controller,"",null);
    }
     ...
     * @param stackPane - the StackPane from the invoking controller used for the AlertDialogBuilder
     */
    public static void setMenuButtonWithViewAndSubMenu(JFXButton button, FontIcon icon, List<JFXButton> drawerMenuList, String tooltipText, AnchorPane contentPane, String fxml, FlowPane subToolbar, MenuControllerHandler controller, String permission, StackPane stackPane) {
        try {
            icon.setIconColor(Paint.valueOf(ColorPalette.WHITE));
            button.setGraphic(icon);
            button.setGraphicTextGap(15);
