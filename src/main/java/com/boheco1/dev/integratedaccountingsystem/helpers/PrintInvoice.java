...
public class PrintInvoice extends Task {
    ...
    public PrintInvoice(List<Bill> bill){
        ...
        for (Bill b : bills)
        {
                    ...
                    try{
                        row=connect.getAllRecord("Select  Bi.AccountNumber, isnull(AM.TINNo,''), substring(AM.ConsumerName,1,35) as ConsumerName,substring(AM.ConsumerAddress,1,50) as ConsumerAddress,ISNULL(Bi.Remarks,'') as SubscriberNo,CONVERT(VARCHAR(10),Bi.ServiceDateFrom,101) as ServiceDateFrom,CONVERT(VARCHAR(10),Bi.ServiceDateTo,101) as ServiceDateTo,Bi.MeterNumber,Routes.RouteCode,Bi.ConsumerType,Bi.Coreloss, CONVERT(VARCHAR(10),Bi.ServicePeriodEnd,101) as BillingMonth," +
                                ...
                                "WHERE Bi.ServicePeriodEnd= '"+ b.getServicePeriodEnd()+ "' and Bi.AccountNumber='"+ b.getConsumer().getAccountID() +"'  ");
                    ...
                    data1=connect.getSpecificRow("Select Count(bills.BillNumber),Sum(bills.NetAmount)   FROM    dbo.Bills LEFT OUTER JOIN dbo.PaidBills ON dbo.Bills.AccountNumber = dbo.PaidBills.AccountNumber AND dbo.Bills.ServicePeriodEnd = dbo.PaidBills.ServicePeriodEnd WHERE (dbo.PaidBills.ServicePeriodEnd IS NULL) AND (dbo.Bills.ServicePeriodEnd > '1/1/2013') AND bills.accountNumber='"+ b.getConsumer().getAccountID() +"' and bills.ServicePeriodEnd < '"+ b.getServicePeriodEnd()+"'  Group By bills.AccountNumber");
